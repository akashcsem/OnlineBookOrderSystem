...
class CartItem implements Arrayable, Jsonable
{
    ...
    public function __construct($id, $name, $price, $image, $weight = 0, array $options = [])
    {
        if (empty($id)) {
    ...
    public function updateFromBuyable(Buyable $item)
    {
        ...
        $this->image = $item->getBuyableDescription($this->options);
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->image = array_get($attributes, 'image', $this->image);
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, $image, $weight, array $options = [])
    {
        return new self($id, $name, $price, $image, $weight, $options);
    }
