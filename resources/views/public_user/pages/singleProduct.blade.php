  ...
  <div class="container clearfix">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">View Detail</a></li>
        ...
        <div class="row py-3">
          {{-- <div class="span4"> --}}
            <div class="col-lg-3 col-md-5 col-sm-7 mb-2">
              <img style="width: 100%; height: 350px;" class="img-left img-thumbnail" src="{{ asset('product/'.$product->image) }}"/>
            </div>
            <div class="content-heading col-lg-9 col-md-7 col-sm-12 mb-2">
              <h4>{{ $product->name }}</h4>
              <p>{{ $product->authorName }} (Author)</p>
              ...
              <p>Publication : {{ $product->publisherName }}</p>
              <br>
              <p>
