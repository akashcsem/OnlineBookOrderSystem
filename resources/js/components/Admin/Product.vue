          ...
          <div class="modal-content">
            ...
            <form @submit.prevent="editMode ? updateProduct() : createProduct()">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <select title="Group Not Required" v-model="form.group_id" name="type" class="form-control" >
                    <option value="">Select Group</option>
                    <option v-for="group in groups" :key="group.id" :value="group.id">{{ group.name }}</option>
                  </select>
                </div>
                <div class="form-group">
                  <select title="Category Required" v-model="form.category_id" name="type" class="form-control"  :class="{ 'is-invalid': form.errors.has('category_id') }">
                ...
                <div class="form-group">
                  <input title="Discount/Offer Price Not Required" v-model="form.offer" type="number" name="offer" placeholder="Ofer Price(%)" class="form-control" >
                </div>

                <div class="form-group">
                  <input title="ISBN Number Not Required" v-model="form.isbn_no" type="text" name="isbn_no" placeholder="ISBN Number" class="form-control" >
                </div>

                <div class="form-group">
                  <select title="Author Required" v-model="form.author_id" name="type" class="form-control" :class="{ 'is-invalid': form.errors.has('author_id') }">
                ...
                <div class="form-group">
                  <select title="Publication Not Required" v-model="form.publication_id" name="type" class="form-control" :class="{ 'is-invalid': form.errors.has('publication_id') }">
                ...
                <div class="form-group">
                  <select title="Status Required" v-model="form.publication_status" name="type" class="form-control" :class="{ 'is-invalid': form.errors.has('publication_status') }">
